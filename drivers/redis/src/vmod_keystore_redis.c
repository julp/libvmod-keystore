...
struct vmod_key_store_redis_data_t {
    unsigned magic;
...
{
    struct vmod_key_store_redis_data_t *d;
...
static void vmod_key_store_redis_close(void *c)
{
    ...
    d = (struct vmod_key_store_redis_data_t *) c;
...
static redisContext *_redis_do_connect(struct vmod_key_store_redis_data_t *d)
{
    int tv_set;
